...
## Project Structure
    ...
    ├── studio_crm_template_41536  # Django project configurations
...
1. Clone this repo and `cd studio_crm_template_41536`
...
2. Clone this repo and `cd studio_crm_template_41536`
