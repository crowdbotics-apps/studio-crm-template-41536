"""
Django settings for studio_crm_template_41536 project.
...
ROOT_URLCONF = 'studio_crm_template_41536.urls'
...
WSGI_APPLICATION = 'studio_crm_template_41536.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "studio_crm_template_41536 API",
    "DESCRIPTION": "API documentation for studio_crm_template_41536 App",
    "VERSION": "v1",
}
